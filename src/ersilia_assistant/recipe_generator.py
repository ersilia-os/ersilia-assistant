...
class RecipeGenerator:
    def __init__(self) -> None:
        ...
        self.run_cmd = "ersilia run -i input.csv -o output.csv"
        self.init_string = """Use the following recipe to run the identified models on your data.
        The following instructions assume that your dataset is stored in a file called 'input.csv'.
    ...
    def generate(self, text: str) -> Generator[str, None, None]:
        ...
        for mdl in models:
            ...
            single_model_recipe += self.run_cmd + "\n"
