...
prompts = {
    ...
    ("M", "N", "Expand"): "I have an initial library of 30 compounds, isolated from plants with activity against _P.falciparum_. Can you help me expand it with new molecules that are easy to synthesize and retain the bioactivity? Scaffold hopping techniques would be useful.",
    ("M", "S", "Select"): "I want to identify synthetic compounds with high efficacy against _Plasmodium falciparum_, the causal agent of malaria, while prioritizing those with good solubility and permeability for initial studies.",
    ("M", "S", "Toxic"): "From an initial hit with _in vitro_ activity against _Plasmodium falciparum_ (IC50 < 1uM), but toxic in human cells, I have devised 100 derivatives. Which ones retain the bioactivity without causing toxicity?",
    ...
    ("T", "N", "Select"): "I need to identify the most effective natural products for _Mycobacterium tuberculosis_ treatment, focusing on compounds with high permeability across the bacterial membrane. What would you recommend for further investigation?",
    ...
    ("T", "N", "Expand"): "My initial set of natural products includes compounds with activity against _Mycobacterium tuberculosis_. How can I explore related chemical structures to identify derivatives that improve solubility and ADME properties?",
    ("T", "S", "Select"): "I want to prioritize synthetic compounds targeting drug-resistant _Mycobacterium tuberculosis_ strains for preclinical studies. How can I do this effectively?",
    ("T", "S", "Toxic"): "I want to use ChemDiv Diversity Set as starting library for my tuberculosis drug discovery program. Which molecules in my library are least likely to interfere with CYP3A4 metabolism while showing selective activity against _Mycobacterium tuberculosis_?",
    ...
    ("C", "S", "Toxic"): "I am at the starting point of a drug discovery campaign for COVID-19. I have a virtual library of 1M compounds. How can I filter it to ensure minimal risk of hERG toxicity while retaining antiviral activity against SARS_CoV-2?",
