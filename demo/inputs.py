...
prompts = {
    ("M", "N", "Select"): "I have a collection of isolated compounds from Cameroonian plants recommended by traditional healers for malaria. How do I identify the most promising candidates?",
    ...
    ("M", "N", "Expand"): "I have an initial library of 30 compounds isolated from plants with activity against P.falciparum. Can you help me expand it with new molecules that are easy to synthesize and retain the bioactivity? Scaffold hopping technique would be useful.",
    ("M", "S", "Select"): "I want to identify synthetic compounds with high efficacy against Plasmodium falciparum while prioritizing those with good solubility and permeability for initial studies.",
    ...
    ("M", "S", "Expand"): "How can I design new synthetic compounds for malaria treatment, particularly for drug-resistant situations, by leveraging scaffold hopping and fragment-based drug design to improve chemical diversity?",
    ("T", "N", "Select"): "I need to identify the most effective natural products for Mycobacterium tuberculosis, focusing on compounds with high permeability across the bacterial membrane. What would you recommend for further investigation?",
    ...
    ("T", "S", "Toxic"): "I want to use ChemDiv Diversity Set as starting library. Which molecules in my library are least likely to interfere with CYP3A4 metabolism while showing selective activity against tuberculosis bacteria?",
